...
Была произведена кластеризация части датасета и понижена размерность до 2, чтобы отразить эмбеддинги в двухмерном пространстве.

# Результаты работы PCA

## ruElectra-large
<p align="center">
  <img src="https://github.com/user-attachments/assets/f9f5f315-0ece-45ab-a8eb-5dc1a576bbac" alt="ruElectra-large" width="500"/>
  <br>
</p>

## ruBert-large
<p align="center">
  <img src="https://github.com/user-attachments/assets/957be6d9-0cca-43d7-9cca-549c7a3dfb0f" alt="ruBert-large" width="500"/>
  <br>
</p>

## ru-en-RoSBERTa
<p align="center">
  <img src="https://github.com/user-attachments/assets/5d9a615e-0851-4b1d-8596-12a100f6e336" alt="ru-en-RoSBERTa" width="500"/>
  <br>
</p>


В итоговом распределении слов попало очень много длинных текстов, которые сложно воспринимать. Для их уменьшения все тексты были разделены по точкам, запятым, переносам строки, единичным буквам (а, и, о, в, б) и союза "или". Далее знаки препинания, фразы из одного слова, короткие слова менее 5 букв были удалены. Проведена лемматизация фраз и сохранение изначальных форм слов в словарь для их последующего восстановления. 
...
## Облако слов NLP
<p align="center">
  <img src="https://github.com/user-attachments/assets/45d03ad1-9563-429a-8c1c-2fffbdbc6718" alt="NLP" width="500"/>
  <br>
</p>

## Гистограмма распределения ответов NLP
<p align="center">
  <img src="https://github.com/user-attachments/assets/992f28f9-08ae-4c9d-af11-83199b975559" alt="NLP2" width="500"/>
  <br>
</p>
...
## ruElectra-large
<p align="center">
  <img src="https://github.com/user-attachments/assets/8ad2fc01-2e43-438d-8f9f-811d4d8efbff" alt="ruElectra-large" width="500"/>
  <br>
</p>

## ruBert-large
<p align="center">
  <img src="https://github.com/user-attachments/assets/14026c83-b752-4d46-89e5-b362bc54b6b9" alt="ruBert-large" width="500"/>
  <br>
</p>

## ru-en-RoSBERTa
<p align="center">
  <img src="https://github.com/user-attachments/assets/870a7cd3-ff20-436b-9ec8-8a8228f8517e" alt="ru-en-RoSBERTa" width="500"/>
  <br>
</p>

Получившиеся облако слов и гистограмма распределения фраз:
## Облако слов ChatGPT
<p align="center">
  <img src="https://github.com/user-attachments/assets/28032947-6416-4919-914f-6e3245fbfc16" alt="ChatGPT" width="500"/>
  <br>
</p>

## Гистограмма распределения ответов ChatGPT
<p align="center">
  <img src="https://github.com/user-attachments/assets/063fb8c1-d131-49dd-b88d-6eab1923225d" alt="ChatGPT2" width="500"/>
  <br>
</p>
...
NLP: 2 минуты на получение всех эмбеддингов  
ChatGPT: 8 минут на получение всех эмбеддингов  

NLP: 60 мс на получение одного эмбеддинга  
ChatGPT: 1 секунда на получение одного эмбеддинга  
